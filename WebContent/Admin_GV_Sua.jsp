                ...
                <form class="form-horizontal" action="suagv?id=<%=objGV.getMagvhd()%>" onsubmit="return check()" accept-charset="UTF-8" method="post">
                    ...
                    <select class="form-control" name="cn" id="cn">
					  ...
					  <%for (CHUYENNGANH objCN : arCN){
						  if(objGV.getMacn().equals(objCN.getMacn())){
						%>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <input class="form-control" name="email" id="email" placeholder="Email" value="<%=objGV.getEmail()%>">
                        </div>   
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <input type="text" class="form-control" name="sdt" placeholder="Số điện thoại" id="sdt" value="<%=objGV.getSdt() %>">
                        </div> 
                    </div>
